...
params <- list( list( 500, c(1,0.5,0.1),(1:8)/8,      8, 3, 1, 4,   0.8, 3, "exp(1:t/6-t/6)", FALSE, TRUE),
  ...
  #               list( 500, c(1,0.5,0.1),(1:8)/4,      8, 3, 1, 4,   0.8, 3, "runif(t)", TRUE, TRUE),
  #               list( 500, c(1,0.5,0.1),(1:8)/4,      8, 3, 1, 4,   0.8, 3, "runif(t)", TRUE, FALSE),
  list( 2000, c(1,0.5,0.1),(1:8)/8,      8, 3, 1, 4,   0.8, 1, "exp(1:t/6-t/6)", FALSE, TRUE),
  list( 2000, c(1,0.5,0.1),(1:8)/8,      8, 3, 1, 4,   0.8, 1, "exp(1:t/6-t/6)", FALSE, FALSE)
  # list( 2000, c(1,0.5,0.1),(1:8)/4,      8, 3, 1, 4,   0.8, 1, "runif(t)", TRUE, TRUE),
  # list( 2000, c(1,0.5,0.1),(1:8)/4,      8, 3, 1, 4,   0.8, 1, "runif(t)", TRUE, FALSE)
  # list( 500, c(1,0.5,0.1),(1:8)/8,      8, 3, 1, 4,   0.8, 3, "runif(t)", TRUE, TRUE),
  # list( 500, c(1,0.5,0.1),(1:8)/8,      8, 3, 1, 4,   0.8, 3, "runif(t)", TRUE, FALSE),
  # list( 2000, c(1,0.5,0.1),(1:8)/8,      8, 3, 1, 4,   0.8, 1, "runif(t)", TRUE, TRUE),
  # list( 2000, c(1,0.5,0.1),(1:8)/8,      8, 3, 1, 4,   0.8, 1, "runif(t)", TRUE, FALSE)
...
for (param in params) {
  ...
  saveRDS(sim, file = sprintf("../results/simulation_binaryLSIR_%d_%d_%d_%d_%d_%d_%d_%.2f_%d_time_%.1s_ind_tpts_%s_delta_y_%s.rds",
