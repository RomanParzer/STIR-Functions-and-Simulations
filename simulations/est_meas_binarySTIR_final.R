...
simulateSDR <- function(nsim, n, B, t, p, rho,H=1, d=1, k=1, npred = n, what_time = "1:t/t",
  ...
  psi_est <- list(LSIR=array(c(0),dim=c(nsim,t,1)))
  phi_est <- list(LSIR=array(c(0),dim=c(nsim,p,1)))
...
#              --------------------------------------------------------
params <- list( #list( 200,0.1*myB12,10, 3, 1, 4,   0.8, 3,"exp(1:t/6-t/6)", FALSE, TRUE),
  # list( 200, 0.1*myB12,10, 3, 1, 4,   0.8, 3,"exp(1:t/6-t/6)", FALSE, FALSE),
  list( 500,0.1*myB12,10, 3, 1, 4,   0.8, 3,"exp(1:t/6-t/6)", FALSE, TRUE),
  list( 500, 0.1*myB12,10, 3, 1, 4,    0.8, 3,"exp(1:t/6-t/6)", FALSE, FALSE),
  list( 2000,0.1*myB12,10, 3, 1, 4,    0.8, 3,"exp(1:t/6-t/6)", FALSE, TRUE),
  list( 2000, 0.1*myB12,10, 3, 1, 4,   0.8, 3,"exp(1:t/6-t/6)", FALSE, FALSE),
  list( 10000,0.1*myB12,10, 3, 1, 4,  0.8, 3,"exp(1:t/6-t/6)", FALSE, TRUE),
  list( 10000, 0.1*myB12,10, 3, 1, 4,   0.8, 3,"exp(1:t/6-t/6)", FALSE, FALSE),
  # list( 200, 0.1*myB12,10, 3, 1, 4,   0.8, 3,     "runif(t)",  TRUE, TRUE),
  # list( 200, 0.1*myB12,10, 3, 1, 4,    0.8, 3,     "runif(t)",  TRUE, FALSE),
  list( 500, 0.1*myB12,10, 3, 1, 4,    0.8, 3,     "runif(t)",  TRUE, TRUE),
  list( 500, 0.1*myB12,10, 3, 1, 4,    0.8, 3,     "runif(t)",  TRUE, FALSE),
  list( 2000, 0.1*myB12,10, 3, 1, 4,  0.8, 3,     "runif(t)",  TRUE, TRUE),
  list( 2000, 0.1*myB12,10, 3, 1, 4,    0.8, 3,     "runif(t)",  TRUE, FALSE),
  list( 10000, 0.1*myB12,10, 3, 1, 4,    0.8, 3,     "runif(t)",  TRUE, TRUE),
  list( 10000, 0.1*myB12,10, 3, 1, 4,   0.8, 3,     "runif(t)",  TRUE, FALSE),
  # list( 200, 0.1*cbind(myB4,myB4,myB4,myB4,myB4),4, 15, 1, 3,   0.8, 3,"exp(1:t/6-t/6)", FALSE, TRUE),
  # list( 200, 0.1*cbind(myB4,myB4,myB4,myB4,myB4),4, 15, 1, 3,   0.8, 3,"exp(1:t/6-t/6)", FALSE, FALSE),
  ...
  list( 2000, 0.1*cbind(myB4,myB4,myB4,myB4,myB4),4, 15, 1, 3,    0.8, 3,"exp(1:t/6-t/6)", FALSE, TRUE),
  list( 2000, 0.1*cbind(myB4,myB4,myB4,myB4,myB4),4, 15, 1, 3,  0.8, 3,"exp(1:t/6-t/6)", FALSE, FALSE),
  list( 10000, 0.1*cbind(myB4,myB4,myB4,myB4,myB4),4, 15, 1, 3,    0.8, 3,"exp(1:t/6-t/6)", FALSE, TRUE),
  list( 10000, 0.1*cbind(myB4,myB4,myB4,myB4,myB4),4, 15, 1, 3,    0.8, 3,"exp(1:t/6-t/6)", FALSE, FALSE),
  # list( 200,       myB5,3, 7, 1, 2,   0.8, 2,             "1:t/t", FALSE, TRUE),
  # list( 200,       myB5,3, 7, 1, 2,   0.8, 2,             "1:t/t", FALSE, FALSE),
  list( 500,       myB5,3, 7, 1, 2,   0.8, 2,             "1:t/t", FALSE, TRUE),
  list( 500,       myB5,3, 7, 1, 2,   0.8, 2,             "1:t/t", FALSE, FALSE),
  list( 2000,       myB5,3, 7, 1, 2,    0.8, 2,             "1:t/t", FALSE, TRUE),
  list( 2000,       myB5,3, 7, 1, 2, 0.8, 2,             "1:t/t", FALSE, FALSE),
  list( 10000,       myB5,3, 7, 1, 2,    0.8, 2,             "1:t/t", FALSE, TRUE),
  list( 10000,       myB5,3, 7, 1, 2,    0.8, 2,             "1:t/t", FALSE, FALSE),
  # list( 200, cbind(myB5,myB5,myB5),3, 21, 1, 2,    0.8, 2,"1:t/t", FALSE, TRUE),
  # list( 200, cbind(myB5,myB5,myB5),3, 21, 1, 2,    0.8, 2,"1:t/t", FALSE, FALSE),
  ...
  list( 2000, cbind(myB5,myB5,myB5),3, 21, 1, 2,    0.8, 2,"1:t/t", FALSE, TRUE),
  list( 2000, cbind(myB5,myB5,myB5),3, 21, 1, 2,    0.8, 2,"1:t/t", FALSE, FALSE),
  list( 10000, cbind(myB5,myB5,myB5),3, 21, 1, 2,   0.8, 2,"1:t/t", FALSE, TRUE),
  list( 10000, cbind(myB5,myB5,myB5),3, 21, 1, 2,   0.8, 2,"1:t/t", FALSE, FALSE),
  # list( 200,       3*myB5,3, 7, 1, 2,   0.8, 2,             "1:t/t", FALSE, TRUE),
  # list( 200,       3*myB5,3, 7, 1, 2,   0.8, 2,             "1:t/t", FALSE, FALSE),
  list( 500,       3*myB5,3, 7, 1, 2,   0.8, 2,             "1:t/t", FALSE, TRUE),
  list( 500,       3*myB5,3, 7, 1, 2,   0.8, 2,             "1:t/t", FALSE, FALSE),
  list( 2000,       3*myB5,3, 7, 1, 2,    0.8, 2,             "1:t/t", FALSE, TRUE),
  list( 2000,       3*myB5,3, 7, 1, 2, 0.8, 2,             "1:t/t", FALSE, FALSE),
  list( 10000,       3*myB5,3, 7, 1, 2,    0.8, 2,             "1:t/t", FALSE, TRUE),
  list( 10000,       3*myB5,3, 7, 1, 2,    0.8, 2,             "1:t/t", FALSE, FALSE)
)
...
for (param in params) {
  ...
  saveRDS(sim, file = sprintf("../results/Final_est_meas_binarySTIR_%d_%d_%d_%d_%d_%d_%d_%.2f_%d_time_%.1s_ind_tpts_%s_delta_y_%s.rds",
