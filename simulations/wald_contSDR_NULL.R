...
params <- list( # list(500,myB12,10, 3, 2, 2,  0.8,"exp(1:t/6)/exp(t/6)", 0:5/10,0:5, TRUE),
  ...
  list( 5000,myB12,10, 3, 2, 2,  0.8,"exp(1:t/6)/exp(t/6)", 0:5/10,0:5, TRUE),
  list( 5000, myB12,10, 3, 2, 2,  0.8, "exp(1:t/6)/exp(t/6)", 0:5/10,0:5, FALSE),
  ...
  list( 5000,       myB5,2, 7, 2, 1,  0.8,     "1:t/t", 0:5/15,0:5/5, TRUE),
  list( 5000,       myB5,2, 7, 2, 1,  0.8,     "1:t/t", 0:5/15,0:5/5, FALSE)
)
